...
float ASLayoutElementYogaBaselineFunc(const struct YGNode *yogaNode, float width, float height)
{
...
YGSize ASLayoutElementYogaMeasureFunc(const struct YGNode *yogaNode, float width, YGMeasureMode widthMode,
