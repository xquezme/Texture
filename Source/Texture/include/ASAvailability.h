...
#define AS_PIN_REMOTE_IMAGE __has_include(<PINRemoteImage/PINRemoteImage.h>)
  ...
  // Detect IGListKit whether installed as a framework (CocoaPods) or as an SPM package (flat headers).
  #define AS_IG_LIST_KIT (__has_include(<IGListKit/IGListKit.h>) || __has_include(<IGListKit.h>))
#endif
#ifndef AS_IG_LIST_DIFF_KIT
  // Detect IGListDiffKit whether installed as a framework (CocoaPods) or as an SPM package (flat headers).
